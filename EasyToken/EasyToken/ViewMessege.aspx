<%@ Page Title="" Language="C#" MasterPageFile="~/ETMaster.Master" AutoEventWireup="true" CodeBehind="ViewMessege.aspx.cs" Inherits="EasyToken.ViewMessege" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="grid_3 grid_4">
    ...
    <asp:Label ID="lblMessege" runat="server" Text="Label"></asp:Label>  </div></div>
